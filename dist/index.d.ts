import { Message, Bot, Interaction } from '@discordeno/bot';
...
declare class ProcessManager {
    ...
    static sessions: Map<string, ProcessManager>;
    target: bigint;
    ...
    private lastUpdate;
    constructor(message: Message, content: string, dokdo: Dokdo, options?: ProcessOptions);
    static handleInteraction(bot: Bot, interaction: Interaction): Promise<boolean>;
    init(): Promise<void>;
...
declare function exec(message: Context, parent: Dokdo): Promise<void>;

declare function js(message: Context, _dokdo: Dokdo): Promise<void>;

declare function jsi(message: Context, _dokdo: Dokdo): Promise<void>;

declare function curl(message: Context, parent: Dokdo): Promise<void>;

declare function cat(message: Context, parent: Dokdo): Promise<void>;
...
declare class Dokdo {
    ...
    owners: bigint[];
    process: never[];
    constructor(bot: Bot, options: DokdoOptions);
    static handleInteraction(bot: Bot, interaction: Interaction): Promise<boolean>;
    run(ctx: Context, usedPrefix?: string): Promise<void>;
    _addOwner(id: bigint): bigint[];
    _removeOwner(id: bigint): bigint[];
}

export { Dokdo as Client, index as Commands, Context, Dokdo, DokdoOptions, DokdoStats, MessageData, index$1 as Utils, Dokdo as default };
